...
print(dir(e1))#tObject introspection means examining the type or properties of an object at runtime — i.e., "inspecting the object while your code is running."